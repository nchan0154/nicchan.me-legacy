...
$(document).ready(function(){$('.topbar__a[href^="'+location.pathname+'"]:first').addClass("topbar--active");var t=$(".hero__overlay"),i=$(".projects-hero__overlay");$(".projects-hero__img");$(window).on("scroll",function(){var e=$(this).scrollTop(),n=(Math.sin(e/50-1.6)+1)/2;console.log(n),t.css({opacity:n}),e>100?i.addClass("projects-hero__overlay--scroll"):i.removeClass("projects-hero__overlay--scroll")})}),lightbox.option({showImageNumberLabel:!1,resizeDuration:400});